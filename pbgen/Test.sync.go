...
func (x *TestSync) MergeDirtyFromPb(r *Test) {
	...
	for _, v := range r.I32Map {
		var tmp = x.GetI32Map().Get(v.GetId())
		if tmp == nil {
	...
	for _, v := range r.U32Map {
		var tmp = x.GetU32Map().Get(v.GetId())
		if tmp == nil {
	...
	for _, v := range r.I64Map {
		var tmp = x.GetI64Map().Get(v.GetId())
		if tmp == nil {
	...
	for _, v := range r.U64Map {
		var tmp = x.GetU64Map().Get(v.GetId())
		if tmp == nil {
	...
	for _, v := range r.BoolMap {
		var tmp = x.GetBoolMap().Get(v.GetId())
		if tmp == nil {
	...
	for _, v := range r.StrMap {
		var tmp = x.GetStrMap().Get(v.GetId())
		if tmp == nil {
	...
	if x.isStrMapDirty() {
		...
		if x.strMap.Len() > 0 {
			x.strMap.Each(func(k string, v *TestStringMapSync) bool {
				...
				vb := v.MergeDirtyToBytes()
				buf = protowire.AppendTag(buf, 21, 2)
				buf = syncdep.AppendFieldValue(buf, vb)
				return true
			})
		}
...
func (x *TestSync) MergeDirtyToPb(r *Test) {
	...
	if x.isI32MapDirty() {
		...
		if r.I32Map != nil {
			for i := len(r.I32Map) - 1; i >= 0; i-- {
				v := r.I32Map[i]
				k := v.GetId()
				if x.i32Map.ContainDeleted(k) {
					r.I32Map = append(r.I32Map[:i], r.I32Map[i+1:]...)
					continue
				}
				if x.i32Map.ContainDirtied(k) {
					...
					tmp := x.i32Map.Get(k)
					if r.I32Map[i] == nil {
						r.I32Map[i] = &TestI32Map{}
					}
					tmp.MergeDirtyToPb(r.I32Map[i])
				}
			}
		} else {
			r.I32Map = make([]*TestI32Map, 0)
		}
	...
	if x.isU32MapDirty() {
		...
		if r.U32Map != nil {
			for i := len(r.U32Map) - 1; i >= 0; i-- {
				v := r.U32Map[i]
				k := v.GetId()
				if x.u32Map.ContainDeleted(k) {
					r.U32Map = append(r.U32Map[:i], r.U32Map[i+1:]...)
					continue
				}
				if x.u32Map.ContainDirtied(k) {
					updated = append(updated, k)
					tmp := x.u32Map.Get(k)
					if r.U32Map[i] == nil {
						r.U32Map[i] = &TestU32Map{}
					}
					tmp.MergeDirtyToPb(r.U32Map[i])
				}
			}
		} else {
			r.U32Map = make([]*TestU32Map, 0)
		}
	...
	if x.isI64MapDirty() {
		...
		if r.I64Map != nil {
			for i := len(r.I64Map) - 1; i >= 0; i-- {
				v := r.I64Map[i]
				k := v.GetId()
				if x.i64Map.ContainDeleted(k) {
					r.I64Map = append(r.I64Map[:i], r.I64Map[i+1:]...)
					continue
				}
				if x.i64Map.ContainDirtied(k) {
					updated = append(updated, k)
					tmp := x.i64Map.Get(k)
					if r.I64Map[i] == nil {
						r.I64Map[i] = &TestI64Map{}
					}
					tmp.MergeDirtyToPb(r.I64Map[i])
				}
			}
		} else {
			r.I64Map = make([]*TestI64Map, 0)
		}
	...
	if x.isU64MapDirty() {
		...
		if r.U64Map != nil {
			for i := len(r.U64Map) - 1; i >= 0; i-- {
				v := r.U64Map[i]
				k := v.GetId()
				if x.u64Map.ContainDeleted(k) {
					r.U64Map = append(r.U64Map[:i], r.U64Map[i+1:]...)
					continue
				}
				if x.u64Map.ContainDirtied(k) {
					updated = append(updated, k)
					tmp := x.u64Map.Get(k)
					if r.U64Map[i] == nil {
						r.U64Map[i] = &TestU64Map{}
					}
					tmp.MergeDirtyToPb(r.U64Map[i])
				}
			}
		} else {
			r.U64Map = make([]*TestU64Map, 0)
		}
	...
	if x.isBoolMapDirty() {
		updated := make([]bool, 0)
		if r.BoolMap != nil {
			for i := len(r.BoolMap) - 1; i >= 0; i-- {
				v := r.BoolMap[i]
				k := v.GetId()
				if x.boolMap.ContainDeleted(k) {
					r.BoolMap = append(r.BoolMap[:i], r.BoolMap[i+1:]...)
					continue
				}
				if x.boolMap.ContainDirtied(k) {
					updated = append(updated, k)
					tmp := x.boolMap.Get(k)
					if r.BoolMap[i] == nil {
						r.BoolMap[i] = &TestBoolMap{}
					}
					tmp.MergeDirtyToPb(r.BoolMap[i])
				}
			}
		} else {
			r.BoolMap = make([]*TestBoolMap, 0)
		}
	...
	if x.isStrMapDirty() {
		...
		if r.StrMap != nil {
			for i := len(r.StrMap) - 1; i >= 0; i-- {
				v := r.StrMap[i]
				k := v.GetId()
				if x.strMap.ContainDeleted(k) {
					r.StrMap = append(r.StrMap[:i], r.StrMap[i+1:]...)
					continue
				}
				if x.strMap.ContainDirtied(k) {
					updated = append(updated, k)
					tmp := x.strMap.Get(k)
					if r.StrMap[i] == nil {
						r.StrMap[i] = &TestStringMap{}
					}
					tmp.MergeDirtyToPb(r.StrMap[i])
				}
			}
		} else {
			r.StrMap = make([]*TestStringMap, 0)
		}
